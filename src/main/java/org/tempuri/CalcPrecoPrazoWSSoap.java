...
public interface CalcPrecoPrazoWSSoap {
    ...
    @RequestWrapper(localName = "CalcPrazoObjeto", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CalcPrazoObjeto")
    @ResponseWrapper(localName = "CalcPrazoObjetoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CalcPrazoObjetoResponse")
